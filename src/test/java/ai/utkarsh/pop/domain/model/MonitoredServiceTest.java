...
class MonitoredServiceTest {
    ...
    void shouldFallBackToTheServiceNameAsThePrometheusLabel() {
        MonitoredService service = MonitoredService.register(NAME, null, null, NOW);
    ...
    void shouldRejectAPrometheusLabelThatCouldInjectPromql() {
        assertThatThrownBy(() -> MonitoredService.register(NAME, "svc\"} or up{", null, NOW))
    ...
    void disableShouldStopItBeingInvestigated() {
        MonitoredService service = MonitoredService.register(NAME, null, TARGET, NOW);
